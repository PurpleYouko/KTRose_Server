...
-- 
-- Host: localhost
-- Generation Time: Aug 05, 2016 at 01:46 PM
...
CREATE TABLE IF NOT EXISTS `list_config` (
  ...
  `maxoverkill` float NOT NULL default '2',
  PRIMARY KEY  (`id`)
